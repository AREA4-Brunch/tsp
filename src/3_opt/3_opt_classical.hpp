#ifndef TSP_3_OPT_CLASSICAL_HPP
#define TSP_3_OPT_CLASSICAL_HPP
...
class LocalSearch3OptClassical : public LocalSearch3Opt<cost_t, vertex_t> {
 public:
    LocalSearch3OptClassical() = default;
    ~LocalSearch3OptClassical() = default;
...
cost_t LocalSearch3OptClassical<cost_t, vertex_t>::run(
