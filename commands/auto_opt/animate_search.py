...
python animate_search.py auto_opt_rand 263 263.txt shp 263 -1 5 red
python animate_search.py auto_opt_classical 263 263.txt shp 263 best 5 red
"""
...
def main():
    args = sys.argv[1:]
    algo = args[0] if len(args) > 0 else 'auto_opt_rand'
